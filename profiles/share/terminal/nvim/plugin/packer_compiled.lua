...
_G.packer_plugins = {
  ...
  ["auto-session"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/auto-session",
  ...
  kanagawa = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/kanagawa",
  ...
  onedark = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/onedark",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
    url = "https://github.com/akinsho/toggleterm.nvim"
  },
  ["vim-nix"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/vim-nix",
